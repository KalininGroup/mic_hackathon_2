...
<style>
/* FAQ accordion styling integrated with existing .section-card design */

.faq-item {
  margin: 1.5rem 0;
  padding: 0; /* section-card handles outer padding */
}
...
.faq-item summary {
  ...
  cursor: pointer;
  font-size: 1.05rem;
  font-weight: 600;   /* medium, not overly bold */
  list-style: none;
  display: flex;
  align-items: center;
  color: #111827;
...
.faq-item summary::before {
  ...
  color: #2563eb; /* matches site accent color */
}
...
.faq-item > *:not(summary) {
  ...
  font-size: 0.98rem;
  line-height: 1.6;
  color: #4b5563; /* soft gray like About page */
}
</style>
