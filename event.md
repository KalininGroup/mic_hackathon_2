...
<div class="photo-grid">
  <a href="{{ '/assets/event_photos/Online/Zoom1.png' | relative_url }}" target="_blank">
    <img src="{{ '/assets/event_photos/Online/Zoom1.png' | relative_url }}" alt="Hackathon Zoom session">
  </a>

  <a href="{{ '/assets/event_photos/Online/Zoom2.png' | relative_url }}" target="_blank">
    <img src="{{ '/assets/event_photos/Online/Zoom2.png' | relative_url }}" alt="Hackathon Zoom session">
  </a>

  <a href="{{ '/assets/event_photos/Online/Zoom3.png' | relative_url }}" target="_blank">
